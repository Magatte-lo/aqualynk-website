...
const team = [
  ...
  },
  {
    ...
    bio: "Chargee de marketing et communication.",
  ...
  },
  {
    ...
    role: "IA",
    bio: "Integration IA dans l'application.",
  ...
  {
    name: "Arame Gningue",
    role: "Securite et deploiement",
    bio: "Charge de securite informatique et deploiement d'applications.",
    photo: "/team/membre7.jpg",
    email: "membre7@aqualynk.sn",
  },
  {
    name: "Seydina Mouhamed Ndiaye",
    role: "Developpeur IOT",
    bio: "Maintenance et deploiement d'applications IoT.",
